...
# This converts the calibration files of the FIP (the actual one) to the simplified one file calibration used here.
# However, the calibration seems to be to imprecise to actually work with. Instead generate a calibration via Sfm.
# Extrinsics from the calibration are only used to later scale to metric distance.
